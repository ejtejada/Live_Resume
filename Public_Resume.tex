...
‭‭\quad\quad\quad$\diamond$ Modifies X.org files in a one click script and creates a backup to allow easy restoration of mining functionality
...
‭‭\quad\quad\quad$\diamond$ Creates a useful toolset of Bash scripts that allow opening sandboxed instances of various gaming platforms
...
‭‭\quad\quad\quad$\diamond$ Developed library to interpolated future particle positions using similarity transforms and lagrange polynomial
...
‭‭%\quad\quad\quad$\diamond$ Maintained the codebase and assigned design and naming conventions for all contributors to the project%[FIXME] Put something stronger here that is CS based.
