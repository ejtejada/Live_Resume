...
‭‭\quad\quad\quad$\diamond$ Collaborated on an RFID tracking system for tracking maintence works in tunnels without GPS signal
...
‭‭%\quad\quad\quad$\diamond$ Ensured safe battery operating conditions 60$^{\circ}$ C using arduinos for temperature controlled fans and kill switches
