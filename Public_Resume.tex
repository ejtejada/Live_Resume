...
%Clickable Header:
\chead{{\Large \textbf{Edgar Tejada}} \linebreak \href{mailto:edgar_tejada0971@elcamino.edu}{edgar\underline{{ }{ }}tejada0971@elcamino.edu} $||$ \href{https://github.com/ejtejada}{https://github.com/ejtejada}}
\rhead{
\begin{picture}(25,25)
\put(0,5){\centering \includegraphics[scale=0.273333]{point2Self}}
\raggedleft
...
\begin{tabularx}{0.8\textwidth} { 
  ...
  | >{\centering\arraybackslash}X |}
	...
	Bash Scripting & Java & Python & CATIA\\ [0.5ex]
	\hline
	MATLAB & git & Solidworks & AWS SDK\\ [0.5ex]
	%\hline
...
‭‭\quad\quad\quad$\diamond$ Collaborated on an RFID location system for tracking maintenance workers in tunnels without GPS signal
...
\linebreak
AWS Certified Cloud Practitioner (CLF-C02)\begin{minipage}{0.63 \linewidth}\begin{flushright}April 2024\end{flushright}\end{minipage}
\linebreak
CATIA - 3D Designer \& Drafter Certificate\begin{minipage}{0.65 \linewidth}\begin{flushright}August 2025\end{flushright}\end{minipage}
